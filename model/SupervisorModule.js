...
const getSupervisorDetails = (ardb_id, branch_code = 0, flag = 'Y', supervisor_id = 0) => {
    return new Promise(async (resolve, reject) => {
        try{
            let select = 'c.branch_name,a.id, a.user_id,a.active_flag,a.device_id,a.device_sl_no,b.supervisor_name,b.supervisor_address,b.phone_no,b.email_id,b.max_amt, a.branch_code, b.supervisor_id, b.ardb_id, b.branch_code, b.allow_collection_days, b.supervisor_code, b.print_opt',
                table_name = 'md_user a, md_supervisor b,md_branch c',
